  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        mono: ["var(--font-fira-code)", "var(--font-jetbrains-mono)", "monospace"],
      },
      colors: {
      ...
      keyframes: {
        ...
        "subtle-glow": {
          "0%, 100%": { boxShadow: "0 0 10px hsl(var(--primary-blue) / 0.2)" },
          "50%": { boxShadow: "0 0 20px hsl(var(--secondary-teal) / 0.3)" },
        },
      },
      animation: {
